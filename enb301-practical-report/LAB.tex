...
\pagebreak    
	...
	The motor response of the theoretical response was derived from $R_f = 25k$ ohms and $R_1 = 10k$ ohms with a calculated overshoot of 5\%. As shown in the figure below, the practal overshoot of this design was considerably less.
	\begin{center}$\%OS = \frac{V_{avg} - V_{max}}{V_{avg}}$\end{center}
