...
\pagebreak    
	...
	% \begin{subfigure}{0.5\textwidth}
	% \includegraphics[width=0.9\linewidth]{Matlab_Code/Figures/C6_theoretical_model.eps} 
	% \caption{Theoretical vs Model Closed Loop Response}
	% \label{fig:subim1}
	% \end{subfigure}
	% \begin{subfigure}{0.5\textwidth}
	% \includegraphics[width=0.9\linewidth]{Matlab_Code/Figures/C6_experimental_model.eps}
	% \caption{Experimental vs Model Closed Loop Response}
	% \label{fig:subim2}
	% \end{subfigure} 
