...
% hey how are YOU going lachlan?\\
% going well :)
<<<<<<< HEAD

%im editing more just to test stoof
...
\pagebreak
  ...
  \caption{\label{fig:rand}Servo Motor Response Modified: $k_m$ & $\alpha$}
  \end{figure}
...
close
 ...
 \begin{subfigure}{0.5\textwidth}
  ...
  \label{fig:subim2}
  \end{subfigure}
    \caption{\label{fig:rand}Servo Motor Response Modeled: $k_m$ & $\beta$}
    \end{figure}
